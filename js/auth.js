...
async function doLogin() {
  ...
  initSB();
  await loginAuth(cpf, senha, btn);
}

async function loginAuth(cpf, senha, btn) {
  ...
  // Master determinado por metadado do usuário no Supabase — sem CPF hardcoded no código
  const master = data.user?.user_metadata?.is_master === true;
